...
- `28409880` — Commission Tree Storage — Adjacency Rows, Integer Position, Whole-Tree Load (SUPERSEDED IN PART 2026-08-04 → 45514754: adjacency/tree die; Postgres placement, envelope-columns/payload-jsonb, integer position, whole-load survive)
