...
// misses cleanly — a `Record` would return `Object.prototype.constructor`
// off a bare index instead of falling back.
...
export function callbackErrorMessage(code: string): string {
	return CALLBACK_ERROR_MESSAGES.get(code) ?? FALLBACK_MESSAGE;
}
