...
//! - [`PgWorkflowStore`] — an account's board reads
//!   ([`domain::ports::WorkflowStore`]); board mutations via
//!   [`PgWorkflowWrites`] ([`domain::ports::WorkflowWrites`]). Both are empty
//!   stubs; no table exists yet.
