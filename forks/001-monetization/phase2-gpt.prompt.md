...
# YOUR OWN PHASE 1 POSITION (unchanged, for reference)
...
# OPPONENT (Gemini) PHASE 1 POSITION
### 1. Recommended Answer
...
# PHASE 2 — REBUTTAL (round 1)

Attack the WEAKEST load-bearing claim in the opponent's position — the claim that, if false, collapses their recommendation. Then state whether/how your own position moves in response to their strongest point. Do not restate your Phase 1. Under 700 words.
